      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-4">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 text-slate-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium px-6 py-4 rounded-xl border border-slate-200 dark:border-slate-600 transition-colors min-h-[56px]"
          >
