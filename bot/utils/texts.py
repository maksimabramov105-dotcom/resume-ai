...
Твой личный AI-карьерный консультант, который поможет найти работу быстрее.

<b>Что я умею:</b>
📄 <b>Резюме</b> — пишу под конкретную вакансию за 30 секунд
✉️ <b>Сопроводительное письмо</b> — цепляющее, персонализированное
🎯 <b>Симуляция собеседования</b> — тренируйся с реальными вопросами
🔍 <b>Анализ вакансии</b> — бесплатно, без регистрации
💬 <b>AI-ассистент</b> — любые вопросы по карьере и не только
...
BOT_DESCRIPTION = (
    "РезюмеАИ — ваш персональный AI-карьерный консультант.\n\n"
    "✅ Резюме под конкретную вакансию — за 30 секунд\n"
    "✅ Сопроводительные письма, которые читают\n"
    "✅ Симуляция собеседования с разбором ошибок\n"
    "✅ Анализ вакансии — бесплатно\n"
    "✅ AI-ассистент по карьере\n\n"
    "Нажмите «Начать» и получите первое резюме бесплатно."
)

BOT_SHORT_DESCRIPTION = "AI-помощник для поиска работы: резюме, письма, собеседования за 30 сек."
