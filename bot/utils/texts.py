...
BOT_DESCRIPTION = (
    "Твой личный AI-карьерный консультант. С нами шансы найти работу — 100%.\n\n"
    "✅ Резюме под вакансию — за 30 секунд\n"
    "✅ Сопроводительное письмо, которое читают\n"
    "✅ Симуляция собеседования с разбором ошибок\n"
    "✅ Анализ вакансии — бесплатно\n"
    "✅ AI-ассистент по карьере 24/7\n\n"
    "Тысячи специалистов уже нашли достойную работу с нами.\n\n"
    "Нажми НАЧАТЬ и получи первое резюме бесплатно."
)
