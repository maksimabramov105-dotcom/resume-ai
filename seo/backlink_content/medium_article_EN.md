...
**Step 2: Resume tailoring** — For each vacancy, send the job description + my base resume to GPT-4 with a prompt that says: 'Rewrite this resume to highlight experience relevant to this role. Do not fabricate anything. Reorder and rephrase existing bullet points to match the job's language.'
